...
adminRouter.get('/dashboard/rooms/create',authMiddleware.requireAuth,authMiddleware.checkRole("admin"),roomController.create);
adminRouter.post('/dashboard/rooms/create',authMiddleware.requireAuth,authMiddleware.checkRole("admin"),roomController.store);
